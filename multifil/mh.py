...
#         print("Constructed Single Spring Head - as in days of yore")
#         self.state = "free"
#         self.g = Spring({
#             'rest_weak': 5,
#             'rest_strong': 0,
...
#             f_y: the radial force generated by the Head
#         """
#         if self._free_energy(tip_location, self.state) < 0:
#             print("Free energy is less than 0")     # NOTE radial force calculation can be found in Head.py
#         return 0.0
#
#     def energy(self, tip_location, state=None):
#         """Return the energy in the xb with the given parameters
